...
namespace lab7_task2
{
    ...
    public class Student : Person
    {
        ...
        public Student(string name, int markMath, int markRu, int markPh) : base(name)
        {
    ...
    class Program
    {
        static void Main()
        {
            ...
            students[0] = new Student("Иванов Иван Иванович", 4, 3, 5);
            students[1] = new Student("Петров Пётр Петрович", 3, 4, 2);
            students[2] = new Student("Сидоров Илья Михайлович", 5, 5, 5);
